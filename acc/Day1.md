...
자산 : 과거 거래의 결과로 현재에 가지고 있는 미래에 경제적 효익을 주는 권리
        (돈 + 돈으로 바꿀 수 있는거 + 돈을 벌 수 있는 것)
        무엇인가를 알아내는 데에 1분밖에 안걸리는 시대에서 자산은 중요한 정보!
부채 : 빌린 돈
자본 = 자산 - 부채!
재무상태표(대차대조표) : 기업/기관의 경제적 상태를 보여 주는 표
                        요거는 Dart를 통해 볼 수 있음!
수익 : 버는거
비용 : 쓰는거
...
기업의 재무상태표 : dart.fss.or.kr
정부의 재무상태표 : alio.go.kr```